...
- (void)initView {
    ...
    self.ratioView = [[UIView alloc] initWithFrame:CGRectMake(0, 100, oriWidth, self.view.frame.size.height  - 200)];
...
- (void)cancel:(id)sender {
    if (self.delegate && [self.delegate conformsToProtocol:@protocol(UpLoadDocumentsDelegate)]) {
