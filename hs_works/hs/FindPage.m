...
- (void)initData
{
    ...
    _nameArray = @[@"交易提醒",@"任务中心",@"活动中心",@"积分竞猜",@"积分商城",@"排行榜",@"直播室"];
    _detailArray = @[@"及时交易时时提醒",@"红包抢不停",@"天天都有福利拿",@"小积分大用处",@"每一天都充满惊喜",@"下一个高手就是你",@"交流互动乐趣不停歇"];
    _imageNameArray = @[@"findPage_04",@"findPage_06",@"findPage_05",@"findPage_07",@"findPage_08",@"findPage_09",@"findPage_10"];
    _enableArray = @[@"1",@"1",@"1",@"0",@"0",@"0",@"0"];
    if (AppStyle_SAlE) {
...
- (void)initTableView
{
    ...
    _tableView.tableHeaderView = findHeaderView;
