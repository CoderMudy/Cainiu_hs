...
-(void)checkStopAndGetRule{
    ...
    if (self.buyState == 0) {
        //止损金额
        stopMoney = ([_priceLabel.text floatValue] - [_chooseDataModel.lowestPrice floatValue]) * [_chooseDataModel.jump floatValue] ;
        //止盈金额
        getMoney = ([_chooseDataModel.highestPrice floatValue] - [_priceLabel.text floatValue]) * [_chooseDataModel.jump floatValue] ;
    }
    else{
        //止损金额
        stopMoney = ([_chooseDataModel.highestPrice floatValue] - [_priceLabel.text floatValue]) * [_chooseDataModel.jump floatValue] ;
        //止盈金额
        getMoney = ([_priceLabel.text floatValue] - [_chooseDataModel.lowestPrice floatValue]) * [_chooseDataModel.jump floatValue] ;
    }
    
    NSLog(@"%f,%f",stopMoney,getMoney);
