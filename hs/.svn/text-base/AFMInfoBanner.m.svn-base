...
//        [self.textLabel setTextColor:self.infoTextColor ?: UIColorFromRGB(kDefaultTextColor)];
        ...
        UIColor *ackgroundColor = [UIColor colorWithRed:85/255.0 green:85/255.0 blue:85/255.0 alpha:0.9];
        UIColor *TextColor = [UIColor colorWithRed:250/255.0 green:255/255.0 blue:255/255.0 alpha:0.97];
        
        [self setBackgroundColor:ackgroundColor];
